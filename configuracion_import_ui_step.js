(function(){
  ...
  function boot(){patchConnect();normalizeScreen();if(batch){status('Hay una grilla pendiente recuperable. Guardá o cancelá antes de importar de nuevo.','warn');loadGrid().catch(e=>status('No pude recuperar grilla: '+(e.message||e),'bad'))}}
