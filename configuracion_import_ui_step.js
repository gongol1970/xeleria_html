(function(){
  ...
  const BK='xeleria_import_batch_id_v2';
  const CK='xeleria_import_channel_v2';
  let busy=false;
  let batch=localStorage.getItem(BK)||'';
  let chan=localStorage.getItem(CK)||'ML';
